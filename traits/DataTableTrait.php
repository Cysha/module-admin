...
trait DataTableTrait
{
    ...
    {
        $this->objTheme->asset()->add('datatable-js', 'https://cdn.datatables.net/1.9.4/js/jquery.dataTables.js', array('app.js'));
        $this->objTheme->asset()->add('datatable-bs-js', 'https://cdn.datatables.net/plug-ins/fcd3b3cf0d/integration/bootstrap/3/dataTables.bootstrap.js', array('datatable-js'));

        $this->objTheme->asset()->add('datatable-bs-css', 'https://cdn.datatables.net/plug-ins/fcd3b3cf0d/integration/bootstrap/3/dataTables.bootstrap.css', array('bootstrap'));
        $this->objTheme->asset()->add('datatable-fa-css', 'https://cdn.datatables.net/plug-ins/725b2a2115b/integration/font-awesome/dataTables.fontAwesome.css', array('bootstrap-bs-css'));
